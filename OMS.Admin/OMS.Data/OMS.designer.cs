...
namespace OMS.Data
{
    ...
    partial void DeleteMedicine(Medicine instance);
		...
		public OMSDataContext() : 
				base(global::OMS.Data.Properties.Settings.Default.OMSConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnLastActivityDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_Medicine", Storage="_Medicines", ThisKey="UserId", OtherKey="CreatedBy")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_Medicine1", Storage="_Medicines1", ThisKey="UserId", OtherKey="UpdatedBy")]
	...
	public partial class Medicine : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private bool _ToBeDisplayedInFrontEnd;
    ...
    partial void OnIsPrescriptionRequiredChanging(bool value);
    partial void OnIsPrescriptionRequiredChanged();
    partial void OnToBeDisplayedInFrontEndChanging(bool value);
    partial void OnToBeDisplayedInFrontEndChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_MedicineName", DbType="NVarChar(MAX)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IsPrescriptionRequired", DbType="Bit NOT NULL")]
		public bool IsPrescriptionRequired
		{
			...
			set
			{
				if ((this._IsPrescriptionRequired != value))
				{
					this.OnIsPrescriptionRequiredChanging(value);
					this.SendPropertyChanging();
					this._IsPrescriptionRequired = value;
					this.SendPropertyChanged("IsPrescriptionRequired");
					this.OnIsPrescriptionRequiredChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ToBeDisplayedInFrontEnd", DbType="Bit NOT NULL")]
		public bool ToBeDisplayedInFrontEnd
		{
			get
			{
				return this._ToBeDisplayedInFrontEnd;
			}
			set
			{
				if ((this._ToBeDisplayedInFrontEnd != value))
				{
					this.OnToBeDisplayedInFrontEndChanging(value);
					this.SendPropertyChanging();
					this._ToBeDisplayedInFrontEnd = value;
					this.SendPropertyChanged("ToBeDisplayedInFrontEnd");
					this.OnToBeDisplayedInFrontEndChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_Medicine", Storage="_aspnet_User", ThisKey="CreatedBy", OtherKey="UserId", IsForeignKey=true)]
		public aspnet_User aspnet_User
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="aspnet_User_Medicine1", Storage="_aspnet_User1", ThisKey="UpdatedBy", OtherKey="UserId", IsForeignKey=true)]
